...
struct DetaileSettingData: Codable {
    
    // 싱글톤 사용 (let을 선언함으로써 인스턴스가 1회생성되는것에 대한 보장을함)
    static var shared = DetaileSettingData(dayToGocalendar: "", dayToComecalendar: "", numPeople:"", budgetAmount: "")
