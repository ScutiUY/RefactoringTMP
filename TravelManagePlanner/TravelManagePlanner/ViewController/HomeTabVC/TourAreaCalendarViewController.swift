//
//  TourAreaCalendarViewController.swift
//  TravelManagePlanner
//
...
class TourAreaCalendarViewController: UIViewController {
    ...
    var tourAreaName: String = ""
    var tourAreaPlace: String = ""
    var tourAreaSIdx: Int = 0
...
//        label.textAlignment = .center
    ...
    // 선택한 숙박장소 지역명
    lazy var selectTourAreaPlace: UILabel = {
        let label = UILabel()
        label.font = UIFont.systemFont(ofSize: 18)
//        label.textAlignment = .center
        label.text = tourAreaPlace
        label.textColor = UIColor(red: 94/255, green: 94/255, blue: 94/255, alpha: 1)
    ...
    lazy var tourAreaAddButton: UIButton = {
        let button = UIButton()
    ...
    func setUpView() {
        ...
        view.addSubview(selectTourAreaPlace)
    ...
    func setLayout() {
        ...
        selectTourAreaPlace.snp.makeConstraints {
        ...
        fscCalendar.snp.makeConstraints {
            $0.top.equalTo(selectTourAreaPlace.snp.bottom).multipliedBy(1.02)
            $0.leading.equalToSuperview().inset(10)
    ...
    @objc func addButtonAction() {
        ...
        let sIdx = String(tourAreaSIdx)
        let vDate = self.selectVisitDate
        let leaveDate = self.selectVisitDate // 테스트 데이터 수정필요
...
extension TourAreaCalendarViewController:FSCalendarDataSource {
    
}

extension TourAreaCalendarViewController:FSCalendarDelegate {
}

extension TourAreaCalendarViewController:FSCalendarDelegateAppearance {
    // 날짜 선택 시 콜백 메소드
